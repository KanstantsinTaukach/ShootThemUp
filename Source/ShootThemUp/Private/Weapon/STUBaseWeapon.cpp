...
void ASTUBaseWeapon::BeginPlay()
{
    ...
    checkf(DefaultAmmo.Bullets > 0, TEXT("Bullets count could'n be less or equal zero"));
    checkf(DefaultAmmo.Clips > 0, TEXT("Clips count could'n be less or equal zero"));
